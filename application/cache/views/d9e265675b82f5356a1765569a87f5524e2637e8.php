    ...
    <tbody>
      <?php $__currentLoopData = $surat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-primary btn-sm" onclick="Edit(<?php echo e($s->id_surat); ?>)"><i class="fas fa-pencil-alt"></i></button>
            <button type="button" class="btn btn-danger btn-sm" onclick="Hapus(<?php echo e($s->id_surat); ?>)"><i class="fas fa-trash-alt"></i></button>
          </td>
        </tr>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="append">SE/WDIII/</span>
                    </div>
...
<?php $__env->startPush('javascript'); ?>
  ...
  <script>
    ...
    function Edit(id) {  
      $.ajax({
        url:'<?php echo base_url('edaran/readBy')?>',
        type:'POST',
        data: {id_surat: id},
        success : function(response){
    ...
    function Hapus(id) {
      ...
      swal({
        ...
        if (result.value) {
          //AJAX
          $.ajax({
            url:'<?php echo base_url('edaran/delete')?>',
            type:'POST',
            data: {id_surat: id},
            beforeSend: function(){
                $.LoadingOverlay("show");
