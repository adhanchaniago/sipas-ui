                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="append">DP/WDIII/</span>
                    </div>
...
<?php $__env->startPush('javascript'); ?>
  ...
  <script>
    ...
    function Edit(id) {  
      $.ajax({
        url:"<?php echo base_url('dispen/readBy')?>",
        type:'POST',
        data: {id_surat: id},
        success : function(response){
    ...
    function Hapus(id) {
      ...
      swal({
        ...
        if (result.value) {
          //AJAX
          $.ajax({
            url:"<?php echo base_url('dispen/delete')?>",
            type:'POST',
            data: {id_surat: id},
            beforeSend: function(){
                $.LoadingOverlay("show");
